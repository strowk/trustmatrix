...
internal class GameTest {
    ...
    val alwaysCheat2_1: GamePosition = GamePosition(0, 1, Player(Strategy.alwaysCheat), arrayListOf({ alwaysCooperate2_2 }))
    val alwaysCooperate2_2: GamePosition = GamePosition(1, 1, Player(Strategy.alwaysCooperate), arrayListOf({ alwaysCheat2_1 }))
    ...
    val alwaysCheat3_1: GamePosition = GamePosition(0, 1, Player(Strategy.alwaysCheat), arrayListOf({ eyeForAnEye3_2 }))
    val eyeForAnEye3_2: GamePosition = GamePosition(1, 1, Player(Strategy.anEyeForAnEye), arrayListOf({ alwaysCheat3_1 }))
